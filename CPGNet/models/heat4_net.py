...
class Heat4Net(nn.Module):
    def __init__(self, in_dim=1026, hidden_dim=512, out_dim=7, n_layers=2, n_heads=4, dropuout=0.1, graph_pooling_type='mean'):
        super(Heat4Net, self).__init__()
        node_dict = {str(i): i for i in range(1)}
        self.node_dict = node_dict
